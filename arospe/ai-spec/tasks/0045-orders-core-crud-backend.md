...
[`create_customers_table`](in-progress/0041-customers-crud-backend.md) for the address-column lengths.
...
[`CustomerValidationRules`](in-progress/0041-customers-crud-backend.md) exactly — `<Noun>ValidationRules` trait,
...
(story [0041](in-progress/0041-customers-crud-backend.md)) are real, shipped tables.
...
| --- | --- | --- |
| `customers` table + `App\Models\Customer` | story [0041](in-progress/0041-customers-crud-backend.md) — **hard dependency; confirm it is `done` before Phase 3** | `orders.customer_id` FKs it; the address snapshot copies its twelve columns |
