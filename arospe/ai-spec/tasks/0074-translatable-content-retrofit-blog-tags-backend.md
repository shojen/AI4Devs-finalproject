...
>
> **Stories 0059 (`blog_tags`), 0070 (the mechanism) and 0068 (`store_languages`) are all Phase 1 files in `ai-spec/tasks/`, not shipped code.** Everything below is designed against their *specified* shape. If any of their Phase 2/3 passes changes that shape, this story must be re-derived rather than silently trusted — the [deferred-findings failure mode](../../docs/errors-log/archive-2026-08-23-to-2026-08-26.md#a-deferred-storys-findings-were-claims-about-a-tree-that-no-longer-existed-and-one-of-them-would-have-reopened-a-bug-in-this-log--2026-08-23) this project already records once. See **R-1**, which asks whether this should be a retrofit at all.
