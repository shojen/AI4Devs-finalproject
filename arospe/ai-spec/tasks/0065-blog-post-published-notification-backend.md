...
> [0046](in-progress/0046-orders-new-order-notification-backend.md) each announce a **row creation** reached from
...
| [0046](in-progress/0046-orders-new-order-notification-backend.md) | **not a dependency** | This story copies its *shape*, not its code. Sequencing is free either way |
...
- **Sibling stories this one copies the shape of:**
  ...
  table's origin) and [0046](in-progress/0046-orders-new-order-notification-backend.md) (the second producer, which
