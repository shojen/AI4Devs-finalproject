...
[0059](in-progress/0059-blog-tags-backend.md) ships with zero consumers, and it discharges 0059's explicit
...
- **[0059](in-progress/0059-blog-tags-backend.md) — hard, blocking, and the only one.** The model, all three
...
readings of [0059](in-progress/0059-blog-tags-backend.md) and [0025](done/0025-product-categories-ui.md), with
