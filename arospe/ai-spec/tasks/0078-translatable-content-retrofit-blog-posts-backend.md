...
- **R-1 — Dropping `blog_posts.title` breaks three already-written sibling stories, and this story cannot
  ...
  - **(b) [0064](in-progress/0064-scheduled-post-auto-publish-backend.md)** asserts at line ~212 that *"only `status`
...
1. **Amend [0063](0063-blog-posts-list-editor-ui.md), [0064](in-progress/0064-scheduled-post-auto-publish-backend.md)
