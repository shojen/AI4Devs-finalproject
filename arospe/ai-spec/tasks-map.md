...
### Done (61) — shipped, out of scope for this graph
...
- **Epic 3 — Customers & Orders (6):** 0041 — the epic's foundation story (the first to close in
...
### Pending — not started (33 numbered + 1 infra doc)
