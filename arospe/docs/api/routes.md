...
- **[Blog routes](blog.md)** — `blog-tags.index` (the thirteenth). Its delete is unconditional, so unlike the product-categories screen there is no blocked state to document.
