# Array Validation Bounds — Per-story status and re-audits

> Part of [Array Validation Bounds](../array-validation-bounds.md). **Read this part when:** you need how the rule was applied/closed per story (0026, 0027, 0028, 0031a), including the mutation-point and loop-work caps. The other parts are listed in the [hub](../array-validation-bounds.md#table-of-contents).
...
[The shapes that do bound it](rule-and-shapes.md#the-shapes-that-do-bound-it) gains a second half: *who chose the
...
writable form input (deliberately not `#[Locked]`, per [database/schema.md](../../database/schema-products/attribute-types-and-values.md#product_attribute_values)),
...
`attributeValueIdRules()` in [database/schema.md](../../database/schema-products/attribute-types-and-values.md#product_attribute_values)).
