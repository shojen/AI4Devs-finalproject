...
An agent working on a specific domain can jump straight to the 1-3 relevant entries below instead of reading the whole log top to bottom — see [contracts.md](contracts/token-and-doc-rules.md#token-efficient-reading-and-dispatch-rule)'s Token-Efficient Reading and Dispatch Rule. Covers all 54 entries across this file and the archive; an entry touching more than one domain is listed under each. `(archive)` marks an entry that lives in [errors-log-archive.md](errors-log-archive.md).

**Livewire/Blade/Flux rendering & compilation quirks**
- [An empty last page after a delete, or a forged `?page=`, was rendered as "no records exist"](errors-log/2026-09-25-to-2026-09-26.md#an-empty-last-page-after-a-delete-or-a-forged-page-was-rendered-as-no-records-exist--2026-09-26) — 2026-09-26
- [A `#[Url]`-bound property is forged input, and validating it against a capped option list rejects real ids](errors-log/2026-09-25-to-2026-09-26.md#a-url-bound-property-is-forged-input-and-validating-it-against-a-capped-option-list-rejects-real-ids--2026-09-26) — 2026-09-26
...
- [Chromium drops `:00` seconds from a `datetime-local` value, so a browser test that types a zero-seconds instant reads back a different string](errors-log/2026-09-25-to-2026-09-26.md#chromium-drops-00-seconds-from-a-datetime-local-value-so-a-browser-test-that-types-a-zero-seconds-instant-reads-back-a-different-string--2026-09-26) — 2026-09-26
...
- [A UI hint disabled the button but not the keyboard, so Enter still submitted what the server would refuse](errors-log/2026-09-25-to-2026-09-26.md#a-ui-hint-disabled-the-button-but-not-the-keyboard-so-enter-still-submitted-what-the-server-would-refuse--2026-09-26) — 2026-09-26
- [A `#[Url]`-bound property is forged input, and validating it against a capped option list rejects real ids](errors-log/2026-09-25-to-2026-09-26.md#a-url-bound-property-is-forged-input-and-validating-it-against-a-capped-option-list-rejects-real-ids--2026-09-26) — 2026-09-26
...
| --- | --- | --- |
| [Entries 2026-09-25 to 2026-09-26](errors-log/2026-09-25-to-2026-09-26.md) | the topic index points at an entry dated 2026-09-25 through 2026-09-26. | An empty last page after a delete, or a forged `?page=`, was rendered as "no records exist"; A `#[Url]`-bound property is forged input...; A UI hint disabled the button but not the keyboard...; Chromium drops `:00` seconds from a `datetime-local` value... |
...
_Last updated: 2026-09-26 — added the 2026-09-25 to 2026-09-26 part (story 0063: paginated-list empty page, `#[Url]` sanitizing, keyboard path of a UI hint, `datetime-local` seconds) and its topic-index rows; the earlier parts are unchanged._
