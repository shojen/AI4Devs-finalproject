...
| Ability | Signature | Rule | Authorized from |
| --- | --- | --- | --- |
| `viewAny` | `(User $actor)` | holds `orders.view` | Nothing yet — story 0055's `mount()` is its first planned caller |
