...
| [Policies: SalesRegion, Media, ProductCategory](authorization/policies-sales-media-categories.md) | you touch `SalesRegionPolicy`, `MediaPolicy` (the first policy behind no route) or `ProductCategoryPolicy`. | `SalesRegionPolicy`; `MediaPolicy`; `ProductCategoryPolicy` |
