...
| `update` | `(User $actor, Order $target)` | holds `orders.edit` — `$target` is **not** consulted today | Nothing yet — stories 0048–0052's future status-transition/line-item-edit writers |
