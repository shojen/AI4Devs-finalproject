...
lang/                   Published translation files, one folder per locale (en/, es/), plus
                        ...
                        payment-methods.php since story 0038; orders.php since story 0045 — two
                        key groups only, statuses/payment_statuses, one leaf per enum case; no
                        screen copy yet, since this story ships no route or component)
resources/
  views/
