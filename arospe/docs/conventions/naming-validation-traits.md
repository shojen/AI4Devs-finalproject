...
_Last updated: 2026-09-24 — Story 0059 (Blog tags — backend). Added `BlogTagValidationRules` — the first trait with two methods for one field (format-only and format-plus-uniqueness) — and recounted the roster from sixteen to seventeen (`ls app/Concerns/*ValidationRules.php`)._
